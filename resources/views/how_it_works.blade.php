...
<div class="py-16 mb-5">
  <div class="container mx-auto px-6 md:px-12">
    ...
    <div class="text-center bg-grey-50 mb-16">
      <h1 class="text-[48px] font-bold text-gray-800">Getting Started</h1>
      <p class="text-gray-600 mt-4 mx-[20rem] text-[20px] ">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-6 md:px-12 mt-16 mb-8">
      ...
      <div class="space-y-4">
        <!-- Step 1 -->
        <div class="relative group bg-gradient-to-r from-[#3ABFF7] to-[#005289] text-white rounded-lg shadow-lg p-4">
          <!-- Garis Samping -->
        ...
        <!-- Steps 2-8 -->
        <div class="relative group bg-white rounded-lg shadow-md p-4 hover:bg-gradient-to-r hover:from-blue-400 hover:to-blue-500 hover:text-white transition duration-300">
          <!-- Garis Samping -->
      ...
      <div class="flex justify-center items-start mt-[-8px]">
        <img src="{{ asset('images/image.png') }}" alt="Mockup Image" class="w-full max-w-lg rounded-lg">
      </div>
    </div>
...
<div class="relative mt-[12rem] mb-[8rem]">
    ...
    <div class="w-full mx-[9rem] flex flex-col-reverse absolute top-[-12rem] md:flex-row items-center rounded-lg mt-8 mb-8">
      ...
      <div class="w-[50rem] mt-12">
        ...
        <!-- Tombol -->
        <a href="#" class="inline-block bg-[#004E89] text-white text-sm font-semibold px-6 py-2 rounded-lg hover:bg-[#003459] transition duration-300">
