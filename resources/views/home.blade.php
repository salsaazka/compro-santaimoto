      ...
      <div class="container mx-auto px-6 md:px-12">
        ...
        <div class="mt-10 flex gap-12 flex-col md:flex-row items-center md:items-start">
          <div class="w-full md:w-1/2 space-y-4">
            ...
            <div data-aos="fade-right" class="relative group item flex items-center p-4 rounded-2xl shadow-md cursor-pointer transition duration-300 bg-white hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-400" onclick="changeImage(0)">
          ...
          <div class="mt-10 md:mt-0 flex justify-center">
            <img data-aos="zoom-in-up" src="{{ asset('images/de-1.png') }}" alt="Phone Mockup" class="main-image rounded-lg">
          </div>
        </div>
      </div>
    </div>
