...
<div class="bg-[#F8F9FB]">
    ...
    <header class="flex flex-col  md:flex-row justify-between items-center px-6 md:px-[6rem] py-12  w-full">
        ...
        <div class="md:w-1/2 text-center md:text-left">
            <h1 class="text-2xl md:text-[48px] font-semibold  bg-gradient-to-r from-[#4499db]  to-[#004370] bg-clip-text text-transparent leading-snug">
    ...
    <section class="text-center px-[4rem] py-12">
        <h2 class="text-[44px] font-bold text-gray-800 mb-8">Core Features</h2>
        <div class="container mx-auto text-left grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
            ...
            <div class="bg-white rounded-2xl shadow-lg border p-6">
                ...
                <p class="text-gray-600 text-[16px]">Users can describe issues or upload photos for real-time analysis.</p>
            </div>
            <!-- Feature 2 -->
            <div class="bg-white rounded-2xl shadow-lg border p-6">
                <h3 class="font-bold text-gray-800 text-[20px] mb-2">Proactive Maintenance Reminders</h3>
                <p class="text-gray-600 text-[16px]">Co-Pilot tracks usage patterns and service history to prompt timely care.</p>
            </div>
            <!-- Feature 3 -->
            <div class="bg-white rounded-2xl shadow-lg border p-6">
                <h3 class="font-bold text-gray-800 text-[20px] mb-2">Personalized Recommendations</h3>
                <p class="text-gray-600 text-[16px]">Based on riding habits, Co-Pilot offers tailored maintenance tips.</p>
            </div>
            <!-- Feature 4 -->
            <div class="bg-white rounded-2xl shadow-lg border p-6">
    ...
    <section class="py-12 bg-blue-50 mx-[6rem] border rounded-2xl">
        <div class="container mx-auto text-center">
            ...
            <h2 class="text-lg md:text-2xl font-bold mt-[-2rem]  bg-gradient-to-r from-[#4499db]  to-[#004370] bg-clip-text text-transparent">Learn more about how Co-Pilot can make every ride safer.</h2>
